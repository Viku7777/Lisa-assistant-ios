const String baseUrl = "https://peace.jackpot92.pk";
const String openAiApiKey = "null";
const String htmlStringLisa= """"<head>
    <style>
        @media (max-width: 100%) {
            div.w-col.w-col-2 {
                display: none;
...
<canvas id="canvas2" width="2000" height="2000">
